  ...
  return (
    <div className="py-12 px-6 rounded-3xl bg-[#FDF9F5] border border-dashed border-[#DBC3B2] text-center flex flex-col items-center justify-center space-y-5">
      ...
      <div className="max-w-md space-y-2">
        ...
        <p className="text-sm font-semibold text-[#6B635C]">
          You haven't done a check-in.
        </p>
        <p className="text-xs text-[#68625D] leading-relaxed pt-1">
      ...
      <div className="flex items-center space-x-1.5 text-[11px] text-[#68625D] pt-2">
