              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <button
                    ...
                    className="text-xs bg-[#FDF9F5] hover:bg-[#DBC3B2]/25 hover:text-[#5A5049] text-[#3C3530] border border-[#EFE8E2] px-3 py-1.5 rounded-lg transition-colors cursor-pointer"
                  >
                    + {tag}
                  </button>
                ))}
